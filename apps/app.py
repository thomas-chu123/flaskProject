...
def create_app(test_config=None):
    ...
    # app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///local.sqlite'
    app.config['SQLALCHEMY_DATABASE_URI'] = f"sqlite:///{basedir / 'local.sqlite'}"
...
#
#     send_email("this is a test", "tomchu12345@gmail.com", "chu_liang_han@hotmail", "happy subscription",
#                "this is a test")
